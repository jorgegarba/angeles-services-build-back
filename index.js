...
const building_routes_v2_public_1 = __importDefault(require("./sequelize/routes/apiv2/building-routes-v2-public"));
...
app.use('/api/v2/public/building', building_routes_v2_public_1.default);
...
sequelize_1.sequelize.sync({ force: false, alter: false }).then(() => {
    // mainSeeder();
    app.listen(PORT, () => {
